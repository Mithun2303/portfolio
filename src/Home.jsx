    ...
    <div className="main-inner  h-[90vh]">
      <section className=" md:min-h-[90vh] h-[90vh] flex-col-reverse flex md:flex-row-reverse md:justify-between md:transition-mild z-0" id="home">
        ...
        <div className="md:w-[50%] md:my-0 my-auto md:relative md:mt-32 relative md:-top-20 text-primaryText flex flex-col justify-center items-center">
          ...
          <div className="flex justify-between w-[70%] mb-16 ">
            <a className="flex border-2 border-white drop-shadow-sm hover:border-primary text-white hover:text-primary rounded-3xl p-2 stroke-white hover:stroke-primary" href="https://docs.google.com/document/d/19aqOnmLk7UfeLVrWFbxvOEsbu1rJVyqlIJkplbdACTY/edit" target="_blank">
            ...
            <div className="flex gap-4 items-center">
              <a href="https://www.instagram.com/_.mithun._.k._.venkatesan._/" target="_blank">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" className=" hover:stroke-primary stroke-white">
              ...
              <a href="https://www.linkedin.com/in/mithun-karthick-venkatesan/" target="_blank" className="">
                <svg width="22" height="21" viewBox="0 0 22 21" fill="none" xmlns="http://www.w3.org/2000/svg" className="  hover:stroke-primary stroke-white">
              ...
              <a href="https://github.com/mithun2303" target="_blank">
                <svg width="22" height="24" viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="  hover:stroke-primary stroke-white">
              ...
              <a href="mailto:mithunkarthick.venkatesan@gmail.com" target="_blank">
                <svg width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="  hover:stroke-primary stroke-white">
