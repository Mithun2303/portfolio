...
export const Home = () => {
    return(
        ...
        <section className="md:min-h-[90vh] h-[100vh] flex md:flex-row-reverse md:justify-between md:transition-mild z-0" id="home">
          <div className="image-wrapper md:flex hidden md:w-[50%]  justify-center items-center">
            <div className="image-container">
              <img src={profile} alt="" className=" object-contain h-[90vh] drop-shadow-img" />
            </div>
          </div>
              ...
              <div className="md:flex gap-x-0 items-center justify-center h-16">
                ...
                <section className="animation overflow-hidden md:h-16 h-32">
                  <div className="first text-5xl text-center text-primary font-bold  flex justify-center items-center md:mb-[4.5rem] md:h-16 w-fit h-32 ">
                      <span className="flex justify-center md:px-2 px-5">
                      &nbsp;Mithun Karthick</span>
                  </div>
                  <div className="second text-5xl text-primary font-bold  flex justify-center items-center  md:mb-[4.5rem] md:h-16 px-1 h-32 w-fit mb-[1.5rem]">
