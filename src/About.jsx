...
export default function About() {
    return (
        <div className="main-inner">
            <section id="about" className=" md:min-h-[90vh]  h-[80vh] flex md:flex-row md:justify-between md:transition-mild z-0" >
                ...
                <div className="md:w-[50%] md:relative md:mt-32 relative -top-20 text-primaryText flex flex-col">
                    <div className="text-left mx-[15%]">
                        ...
                        <div className="md:flex gap-x-0 md:justify-start  md:w-full mt-12">
                            <p className=" text-xl w-full text-left text-textColor">
