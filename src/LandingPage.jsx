...
export const LandingPage = () => {
  return (
    <main className=" h-fit bg-black">
      <section className="h-[10vh] bg-black flex justify-between px-12 drop-shadow-3xl sticky top-0 z-30">
      ...
      <section className=" min-h-[90vh] flex justify-between transition-mild z-0" id="home">
